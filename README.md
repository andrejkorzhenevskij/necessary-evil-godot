...
ending_id сохраняется как производное представление результата; фактический финал рассчитывается из dominant_zone и накопленных метрик.ending_id сохраняется как производное представление результата; фактический финал рассчитывается из dominant_zone и накопленных метрик.
